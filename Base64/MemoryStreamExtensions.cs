...
namespace Base64
{
	public static class MemoryStreamExtensions
	{
		...
		public static void WriteBase64(this Stream stream, string str)
		{
			int bufferSize = EstimateBufferSize(NoBomEncoding.UTF8, str);

			using (CryptoStream base64Stream = new CryptoStream(stream, new ToBase64Transform(), CryptoStreamMode.Write))
			using (var writer = new StreamWriter(base64Stream, NoBomEncoding.UTF8, bufferSize, true))
			{
				writer.Write(str);
				writer.Flush();
			}
